    ...
    public void createPlateau() {
        ...
        for(int i=0; i<cases.length; i++) {
            for(int j=0; j<cases[i].length; j++) {
                cases[i][j]= new Case("ORANGE");
                cases[i][j]= new Case("RED");
                cases[i][j]= new Case("GREEN");
                cases[i][j]= new Case("PINK");
                cases[i][j]= new Case("YELLOW");
                cases[i][j]= new Case("BLUE");
                cases[i][j]= new Case("PURPLE");
                cases[i][j]= new Case("BROWN");
            }
        }
    }
